...
import { login } from "../../Requests/ForAuth";
  ...
  const onSubmit = async (formData) => {
    ...
    try {
      ...
      if (token) {
        ...
        errorAlert('Проверьте почту или пароль!');
      }
    } catch (err) {
    ...
    <ThemeProvider theme={theme}>
      <Grow in={true} timeout={1100}>
        <Container maxWidth="sm" className={styles.containerWrapper}>
          ...
          <Box>
            <Typography component="span" fontWeight="100" sx={{ color: 'white' }}>New to Admin Panel? </Typography>
